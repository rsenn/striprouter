...
GeneticAlgorithm::GeneticAlgorithm(int nOrganismsInPopulation, double crossoverRate, double mutationRate)
    : nOrganismsInPopulation_(nOrganismsInPopulation), crossoverRate_(crossoverRate), mutationRate_(mutationRate),
      nConnectionsInCircuit_(0), population_(nOrganismsInPopulation, crossoverRate, mutationRate) {}

void
GeneticAlgorithm::reset(int nConnectionsInCircuit) {
...
OrderingIdx
GeneticAlgorithm::reserveOrdering() {
...
ConnectionIdxVec
GeneticAlgorithm::getOrdering(OrderingIdx orderingIdx) {
...
void
GeneticAlgorithm::releaseOrdering(OrderingIdx orderingIdx, int nCompletedRoutes, long completedRouteCost) {
