...
namespace std {
bool
operator<(const Via& l, const Via& r) {
...
ValidVia::ValidVia(const Via& _via, bool _isValid) : via(_via), isValid(_isValid) {}
...
LayerVia::LayerVia(const LayerVia& other) : via(other.via), isWireLayer(other.isWireLayer) {}

LayerVia::LayerVia(const Via& _via, bool _isWireLayer) : via(_via), isWireLayer(_isWireLayer) {}

LayerVia::LayerVia(const LayerCostVia& viaLayerCost) : via(viaLayerCost.via), isWireLayer(viaLayerCost.isWireLayer) {}

namespace std {

bool
operator<(const LayerVia& l, const LayerVia& r) {
...
LayerCostVia::LayerCostVia(const LayerVia& viaLayerIn, int costIn) : ::LayerVia(viaLayerIn), cost(costIn) {}
...
namespace std {
bool
operator<(const LayerCostVia& l, const LayerCostVia& r) {
...
StartEndVia::StartEndVia(const Via& startIn, const Via& endIn) : start(startIn), end(endIn) {}
...
LayerStartEndVia::LayerStartEndVia(const LayerVia& startIn, const LayerVia& endIn) : start(startIn), end(endIn) {}
